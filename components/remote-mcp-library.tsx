...
const remoteMCPServers: RemoteMCPServer[] = [
  ...
  { name: 'Invidio', category: 'Video Platform', url: 'https://mcp.invideo.io/sse', authentication: 'OAuth2.1', maintainer: 'Invidio' },
  ...
  { name: 'monday.com', category: 'Productivity', url: 'https://mcp.monday.com/sse', authentication: 'OAuth2.1', maintainer: 'monday MCP' },
  ...
  { name: 'Prisma Postgres', category: 'Database', url: 'https://mcp.prisma.io/mcp', authentication: 'OAuth2.1', maintainer: 'Prisma Postgres' },
...
export function RemoteMCPLibrary({ onAddServer }: RemoteMCPLibraryProps) {
  ...
  const categories = ['all', ...Array.from(new Set(remoteMCPServers.map(s => s.category)))].sort();
        ...
        <DialogContent className="max-w-[90vw] w-[90vw] max-h-[85vh]" style={{ maxWidth: '90vw', width: '90vw' }}>
          <DialogHeader>
            ...
            <DialogDescription className="text-sm">
              Browse and add remote MCP servers to your client. OAuth servers will open an authentication window.
            </DialogDescription>
          </DialogHeader>
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1 space-y-2">
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            <Badge 
                              variant={getAuthBadgeVariant(server.authentication)}
                          ...
                          <div className="space-y-1">
                            ...
                            <p className="text-sm text-muted-foreground">
                              Maintained by <span className="font-medium">{server.maintainer}</span>
                            </p>
                          </div>
                        </div>
                        <Button
                          ...
                          className="gap-2"
                        >
                          {isConnecting && selectedServer?.name === server.name ? (
                            <>
        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button
                onClick={() => selectedServer && connectWithMcpRemote(selectedServer)}
